	...
	if (bCanSeePlayer != bPreviousCanSeePlayer)
	{
		if (bCanSeePlayer)
		{
			...
			GetWorldTimerManager().SetTimer(ThrowTimerHandle,
				this,
				&ANeutralCharacter::ThrowDodgeball, // 사용할 함수
...
void ANeutralCharacter::ThrowDodgeball() // 탄막 생성하고 던지는 함수
{
	...
	if (UHealthComponent::myVote < ADodgeballCharacter::neutralchangebuff) // 득표율이 기준보다 적으면 탄막 투척
	{
